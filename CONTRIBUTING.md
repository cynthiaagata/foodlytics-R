...
Report bugs at https://github.com/cynthiaagata/foodlytics-R/issues.
...
[open an issue](https://github.com/cynthiaagata/foodlytics-R/issues)
to let us know what you will be working on so that we can provide you with guidance.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/cynthiaagata/foodlytics-R/issues. If your feedback fits the format of one of
